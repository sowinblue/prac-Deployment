...
🔗 **서비스 URL**
👉 [https://prac-deploy.pages.dev/](https://prac-deploy.pages.dev/)

---

## 📌 소개

**Bang!**은 팀원 구성, 순서 결정, 자리 배치 등 다양한 상황에서
공정하고 재미있게 결정을 내릴 수 있도록 돕는 **다기능 랜덤 뽑기 웹 애플리케이션**입니다.

React 기반으로 개발되었으며, 직관적인 UI와 게임형 인터랙션을 통해
빠르고 공정한 의사결정을 지원합니다.
...
* GitHub Actions + Docker 기반 자동 배포 구성

### 🔹 반응형 UI

* 다양한 화면 크기에서 안정적인 레이아웃 제공
